...
export default function InterviewStagePanel({
  ...
  if (interviewsStarted) {
    return (
      ...
      >
        <div className="px-4 sm:px-6 lg:px-10 pt-4 sm:pt-6 lg:pt-8 pb-3 sm:pb-4 border-b border-[var(--violet-border)]/50 shrink-0">
          <p className="font-mono-label text-xs sm:text-sm uppercase tracking-[0.25em] sm:tracking-[0.3em] text-emerald-400/90 mb-1.5 sm:mb-2">
            Live — interviews in progress
          </p>
          <h1 className="text-xl sm:text-3xl lg:text-5xl font-semibold text-glow-violet tracking-tight leading-tight">
            {pickedNames(selectedIds)}
          </h1>
          <p className="text-sm sm:text-base lg:text-lg text-[var(--text-muted)] mt-2 sm:mt-3">
            Pair iPads:{' '}
            <a
    ...
    >
      <div className="px-4 sm:px-8 lg:px-14 pt-6 sm:pt-10 lg:pt-12 pb-4 sm:pb-6 border-b border-[var(--violet-border)]/50 shrink-0">
        ...
        <TypewriterBlock
          ...
          cursorBright
        />
        <p className="text-base sm:text-xl lg:text-2xl text-[var(--text-muted)] mt-3 sm:mt-4">
